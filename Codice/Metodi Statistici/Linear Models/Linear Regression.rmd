...
```{r}
saveRDS(formula, file = "Codice/Metodi Statistici/saved models/Linear Regression/formula_ridotta_lr.rds")
```
...
```{r}
saveRDS(bestlam, file = "Codice/Metodi Statistici/saved models/Linear Regression/best_lambda_ridge.rds")
```
```{r}
library(ggplot2)
...
```{r}
# lasso
saveRDS(bestlam, file = "Codice/Metodi Statistici/saved models/Linear Regression/best_lambda_lasso.rds")
```
...
```{r}
saveRDS(object = errors[,-1], file = "Codice/Metodi Statistici/saved models/metriche_errori/Regressioni_lineari.rds")
```
